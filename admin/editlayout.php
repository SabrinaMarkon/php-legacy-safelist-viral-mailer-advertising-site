...
$adminnavcontent = stripslashes($adminnavcontent);
$adminnavcontent = str_replace('\\','',$adminnavcontent);
...
$membernavcontent = stripslashes($membernavcontent);
$membernavcontent = str_replace('\\','',$membernavcontent);
...
$stylescontent = stripslashes($stylescontent);
$stylescontent = str_replace('\\','',$stylescontent);
...
$splashcontent = stripslashes($splashcontent);
$splashcontent = str_replace('\\','',$splashcontent);
