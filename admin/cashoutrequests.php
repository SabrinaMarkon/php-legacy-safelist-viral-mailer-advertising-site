...
$r2 = mysql_query($q2);
$q3 = "update cashoutrequests set paid=\"$payewallet\",lastpaid=NOW() where id=\"$payid\"";
$r3 = mysql_query($q3);
...
<td align="center"><b><?php echo $ewalletname ?> Balance</b></td>
...
$ewalletq = "select * from members where userid=\"$userid\"";
$ewalletr = mysql_query($ewalletq);
$ewalletrows = mysql_num_rows($ewalletr);
if ($ewalletrows > 0)
	{
	$ewallet = mysql_result($ewalletr,0,"ewallet");
	}
...
<td align="center">$<?php echo $ewallet ?></td>
