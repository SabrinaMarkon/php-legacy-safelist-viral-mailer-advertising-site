...
$today = date('Y-m-d',strtotime("now"));
			...
			if($item == $sitename." - ".$ewalletname." - ".$userid) {
				...
				$r = mysql_query($q);
				mysql_query("INSERT INTO transactions (userid,transaction,description,paymentdate,amountreceived) VALUES ('".$userid."','".$transaction."','OKPay payment - Add to '".$ewalletname."','".time()."','".$amountwithoutfee."')");
			}
