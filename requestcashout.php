...
if ($minimumewalletbalancetowithdraw > $ewallet)
	{
	$error .= "<div>Sorry, you don't have the minimum required " . $ewalletname . " balance needed to make cash withdrawals.</div>";
	}
if ($cashoutamount > $ewallet)
	{
	$error .= "<div>You do not have \$" . $cashoutamount . " in earnings to withdraw.</div>";
	}
if ($maximumpercentageofewalletthatcanbewithdrawnascash > 0)
	{
	$totalavailabletowithdrawascash = ($maximumpercentageofewalletthatcanbewithdrawnascash*$ewallet)/100;
	$totalavailabletowithdrawascash = sprintf("%.2f", $totalavailabletowithdrawascash);
	if ($cashoutamount > $totalavailabletowithdrawascash)
		{
		$error .= "<div>Sorry, the maximum cash withdrawal you may make is less than the amount you requested. You may currently withdraw in cash \$" . $totalavailabletowithdrawascash . ", which is " . $maximumpercentageofewalletthatcanbewithdrawnascash . "% of your total " . $ewalletname . " balance.</div>";
		}	
	}
...
$body .= "Message:\n$message\n\n";
$body .= "Total $ewalletname Balance: \$$ewallet\n";
$body .= "\n";
...
<tr><td align="center" colspan="2">Cash Out Earnings From <?php echo $ewalletname ?></td></tr>
<?php
if ($minimumpayout > 0)
	{
?>
...
if ($minimumewalletbalancetowithdraw > 0)
	{
?>
<tr class="sabrinatrdark"><td align="center" colspan="2">Minimum Total <?php echo $ewalletname ?> Balance To Be Allowed To Withdraw Cash: $<?php echo $minimumewalletbalancetowithdraw ?></td></tr>
<?php
	}
if ($maximumpercentageofewalletthatcanbewithdrawnascash > 0)
	{
	...
	$totalavailabletowithdrawascash = sprintf("%.2f", $totalavailabletowithdrawascash);
?>
<tr class="sabrinatrdark"><td align="center" colspan="2">Total <?php echo $ewalletname ?> Balance: $<?php echo $ewallet ?></td></tr>
<tr class="sabrinatrdark"><td align="center" colspan="2">Your Maximum <?php echo $ewalletname ?> Earnings That Can Be Withdrawn As Cash (<?php echo $maximumpercentageofewalletthatcanbewithdrawnascash ?>% of <?php echo $ewalletname ?> balance): $<?php echo $totalavailabletowithdrawascash ?></td></tr>
<?php
	}
?>
