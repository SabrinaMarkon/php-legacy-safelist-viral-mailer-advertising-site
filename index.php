...
{
$membercountq = "select * from members where verified=\"yes\"";
$membercountr = mysql_query($membercountq);
$totalverifiedmembers = mysql_num_rows($membercountr);
echo "<br>" . $totalverifiedmembers . " Verified Members<br><br>";
}
...
<br>
<a href="http://demoviralmailerbasic.phpsitescripts.com/admin" target="_blank"><img src="http://phpsitescripts.com/images/demo.png" border="0"></a>
<br><br><br>
Please check out our interactive DEMO of the Basic Version Viral Mailer & Advertising Site Script as an admin <a href="http://demoviralmailerbasic.phpsitescripts.com/admin" target="_blank">HERE</a> (admin login details are already in the login form for you). <br><br>Examine our DEMO site as a member <a href="http://demoviralmailerbasic.phpsitescripts.com/login.php" target="_blank">HERE</a> (demo member details are already in the login form)</b><br><br>
...
<tr><td colspan="2" align="center"><br><font size="6" color="ff0000">Buy This Basic Version Viral Mailer & Advertising Site Script Now For Only $79.00!</font></td</tr>
<form action="http://phpsitescripts.com/sales_order.php" method="post">
<tr><td align="right">Licence:</td><td>Single Site License for Basic Version Viral Mailer & Advertising Site Script</td></tr>
...
<option value="Dedicated VPS Hosting 4 GB RAM - adds 99.99/month to order">Dedicated VPS Hosting - adds 99.99/month to order</option>
</select>
</td></tr>
...
<input type="hidden" name="order_script" value="viral_mailer_and_advertising_script_basic_v1.9">
