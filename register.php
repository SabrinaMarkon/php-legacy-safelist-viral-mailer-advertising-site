...
#############################
$freeq = "insert into members (userid,password,accounttype,membershiplastpaid,firstname,lastname,country,email,egopay,payza,perfectmoney,okpay,solidtrustpay,paypal,signupdate,signupip,referid,lastsolopost,nextsolopost,lastcreditsolopost,nextcreditsolopost,verifycode) values (\"$userid\",\"$password\",\"FREE\",\"$today\",\"$firstname\",\"$lastname\",\"$country\",\"$email\",\"$egopay\",\"$payza\",\"$perfectmoney\",\"$okpay\",\"$solidtrustpay\",\"$paypal\",NOW(),\"$signupip\",\"$referid\",NOW(),NOW(),NOW(),NOW(),\"$unixtimestamp\")";
