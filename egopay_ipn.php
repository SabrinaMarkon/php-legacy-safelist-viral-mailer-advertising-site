	...
	$numrows = @ mysql_num_rows($result);
		...
		if ($numrows == 1) 
		{
			...
			if($item == $sitename." - ".$ewalletname." - ".$userid)
			{
				...
				$r = mysql_query($q);
				mysql_query("INSERT INTO transactions (userid,transaction,description,paymentdate,amountreceived) VALUES ('".$userid."','".$transaction."','EgoPay payment - Add to '".$ewalletname."','".time()."','".$amountwithoutfee."')");
			}
