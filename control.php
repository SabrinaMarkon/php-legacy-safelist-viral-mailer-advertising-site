...
$loginrows = mysql_num_rows($loginr);
	...
	$vacation = mysql_result($loginr,0,"vacation");
	$vacationdate = mysql_result($loginr,0,"vacationdate");
	$lastsolopost = mysql_result($loginr,0,"lastsolopost");
	$nextsolopost = mysql_result($loginr,0,"nextsolopost");
	$ewallet = mysql_result($loginr,0,"ewallet");
	$credits = mysql_result($loginr,0,"credits");
	$ewalletlastpaid = mysql_result($loginr,0,"ewalletlastpaid");
	$lastmailedreferrals = mysql_result($loginr,0,"lastmailedreferrals");
	$membershiplastpaid = mysql_result($loginr,0,"membershiplastpaid");
	$lastcreditsolopost = mysql_result($loginr,0,"lastcreditsolopost");
	$nextcreditsolopost = mysql_result($loginr,0,"nextcreditsolopost");
	if ($accounttype == "PAID")
		{
