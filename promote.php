...
<div style="width: 600px; height: 20px; padding: 4px; overflow:auto; border-style: solid; border-size: 1px; border-color: #999999; background: #ffffff; color:#000000;"><?php echo $emailpromotionalsubject ?></div>
<div style="width: 600px; height: 200px; padding: 4px; overflow:auto; border-style: solid; border-size: 1px; border-color: #999999; background: #ffffff; border-top: 0px; color:#000000;"><?php echo $emailpromotionaladbody ?></div>
</center>
</td></tr>
<?php
	}
